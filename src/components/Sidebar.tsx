...
const Sidebar: React.FC = () => {
  ...
  const navItems = [
    ...
    { path: '/dashboard/categories', icon: <FolderOpen className="w-5 h-5" />, label: 'Categories' },
    { path: '/dashboard/appointments', icon: <Calendar className="w-5 h-5" />, label: 'Appointments' },
